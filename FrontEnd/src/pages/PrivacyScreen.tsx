  ...
  return (
    <Container className="my-4">
      <p>
        ...
        <p>
          This privacy policy applies to the OSTA app (hereby referred to as "Application") for mobile devices that was created by (hereby
        ...
        <p>
          ...
          bauwendr@gmail.com and they will respond in a reasonable time.
        </p>
        <br />
        ...
        <div>
          ...
          <p>
            ...
            to the Service Provider through the Application and/or Services, please contact the Service Provider (bauwendr@gmail.com) so
            that they will be able to take the necessary actions. You must also be at least 16 years of age to consent to the processing of
        ...
        <br />
        <p>This privacy policy is effective as of 2024-05-29</p>
        <br />
        ...
        <p>
          ...
          Service Provider via email at bauwendr@gmail.com.
        </p>
        <hr />
        <p>
